...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function updateVariantMetafields(variantId) {
    ...
    if (selectedVariant && selectedVariant.metafields) {
      updateField('metafield-illustrateur', selectedVariant.metafields.custom.illustrateur);
      updateField('metafield-contributeur', selectedVariant.metafields.custom.contributeur_s);
      updateField('metafield-age', selectedVariant.metafields.custom.age);
      updateField('metafield-tags', selectedVariant.metafields.custom.tags);
      updateField('metafield-dimensions', selectedVariant.metafields.custom.dimensions);
      updateField('metafield-weight', selectedVariant.metafields.custom.weight);
      updateField('metafield-pages', selectedVariant.metafields.custom.pages);
      updateField('metafield-summary', selectedVariant.metafields.custom.summary);
    } else {
      updateField('metafield-illustrateur', '');
      updateField('metafield-contributeur', '');
      updateField('metafield-age', '');
      updateField('metafield-tags', '');
      updateField('metafield-dimensions', '');
      updateField('metafield-weight', '');
      updateField('metafield-pages', '');
      updateField('metafield-summary', '');
    }
  }

  if (variantSelect) {
    variantSelect.addEventListener('change', function() {
      updateVariantMetafields(this.value);
    });

    // Initialiser avec la première variante sélectionnée
    updateVariantMetafields(variantSelect.value);
  }
});
</script>
